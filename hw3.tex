...
\lstinputlisting[language=Python, firstline=55, lastline=228, caption={稳定性验证、精度验证、相位超前与耗散分析代码}, label={lst:extracted_python_code2}]{code.py}
...
\newpage
\section{精度验证}
数值格式的精度通过计算数值解与解析解之间的最大绝对误差来验证。以下是各格式的精度验证结果：
